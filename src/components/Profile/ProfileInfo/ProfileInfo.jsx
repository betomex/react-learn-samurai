...
const ProfileInfo = ({userProfile, status, putStatus, isOwner, putPhoto, putProfile}) => {
  ...
  return (
    <div>
      <div className="descBlock">
        ...
        {editMode ? <ProfileDataReduxForm userProfile={userProfile} initialValues={userProfile} onSubmit={onSubmit}/> :
...
const ProfileData = ({userProfile, isOwner, toggleEditMode}) => {
  return <div>
    {isOwner && <div>
    ...
    .map(key => <Contact key={key} contactTitle={key} contactValue={userProfile.contacts[key]}/>)}
  </div>
}
